...
include_once('lib/PHPRtfLite/Font.php');
...
class PHPRtfLite_FontTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetContent()
    {
        ...
        $this->_font->setLetterSpacing(-20);
        $this->_font->setAnimation(PHPRtfLite_Font::ANIMATE_LAS_VEGAS_LIGHTS);
        $this->_font->setDoubleStriked();
        $this->assertEquals('\fs20 \expnd-20 \expndtw-20 \b \i \ul \animtext1\striked1 1', trim($this->_font->getContent()));
    }
}
